# Curso Pílulas de Ouro

- [x] Transcrever os dez vídeos e verificar as saídas locais.
- [x] Inicializar Git e bloquear materiais privados.
- [x] Receber escolha do formato v2.
- [x] Concluir aulas, exercícios e materiais próprios em português.
